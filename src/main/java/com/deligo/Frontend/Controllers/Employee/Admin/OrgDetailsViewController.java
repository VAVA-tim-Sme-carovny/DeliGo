...
public class OrgDetailsViewController implements Initializable {
    ...
    public OrgDetailsViewController(MainPageController mainPageController) {
...
//        OrgDetails details = orgDetails.get(0);
        ...
        JsonObject hoursJson = JsonParser.parseString(details.getOpeningTimes()).getAsJsonObject();
